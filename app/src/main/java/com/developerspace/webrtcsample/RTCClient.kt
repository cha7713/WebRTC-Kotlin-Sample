...
class RTCClient(
    ...
    private val iceServer = listOf(
        PeerConnection.IceServer.builder("stun:stun.l.google.com:19302")
            .createIceServer(),
        PeerConnection.IceServer.builder("turn:121.138.60.100:3478").setPassword(BuildConfig.TURN_USER).setUsername(BuildConfig.TURN_PW)
            .createIceServer(),
...
//                    if (dataSnapshot.contains("type") && dataSnapshot["type"] == "offerCandidate") {
                    val sdpMLineIndex = dataSnapshot["sdpMLineIndex"] as List<String>
                    val sdpMid = dataSnapshot["sdpMid"] as List<String>
                    val sdpCandidate = dataSnapshot["sdpCandidate"] as List<String>
